import type { Discord } from '@proj-rin/server-shared/types'
import type { Interaction } from 'discord.js'

import { env } from 'node:process'

import { useLogg } from '@guiiai/logg'
import { Client as AiriClient } from '@proj-rin/server-sdk'
import { ContextUpdateStrategy } from '@proj-rin/server-shared/types'
